...
void Participant::CreateFastRtpsParticipant(
  ...
  attr.rtps.builtin.discovery_config.discoveryProtocol = eprosima::fastrtps::rtps::DiscoveryProtocol::SIMPLE;
  ...
  attr.rtps.builtin.discovery_config.leaseDuration_announcementperiod.seconds = part_attr_conf->announcement_period();
